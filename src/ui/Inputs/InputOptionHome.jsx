...
const ContainerElement = styled.div`
  color: ${(props) =>
    props.selected ? "var(--DarkGray, #373737)" : "var(--LightGray, #8E8E8E)"};
  display: flex;
...
export function InputOptionHome({
  label,
  type,
  placeholder,
  handleChange,
  ...
  return (
    <Container>
      ...
      <ContainerInputText maxWidth="22.25rem" {...props}>
        ...
        />
        {showOptions ? (
          <MdKeyboardArrowUp style={{ fontSize: "22px", color: "#616161" }} />
        ) : (
